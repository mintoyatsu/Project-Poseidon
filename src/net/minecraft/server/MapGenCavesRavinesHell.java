...
public class MapGenCavesRavinesHell
{
    ...
    public MapGenCavesRavinesHell(World par1World)
    {
    ...
    private void replaceBlock(int index, int x, int z)
    {
        ...
        if (this.chunkData[index] == Block.NETHERRACK.id)
        {
            if (y < 24)
            {
                return;
            ...
            if (y < 32)
            {
                ...
                if (y < 64)
                {
                    ...
                    if (var13 == Block.GRAVEL.id) {
                        this.chunkData[index + 1] = (byte) Block.NETHERRACK.id;
                    }
                }
            }
        }
